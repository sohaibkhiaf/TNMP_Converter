...
app.config["SQLALCHEMY_DATABASE_URI"] = (
    "sqlite:///" + os.path.join(BASE_DIR, "normal_maps.db")
)
...
class NormalMap(db.Model):
    ...
    texture_url = db.Column(
        db.String(500),
        nullable=False
    )

    # URL/path of generated normal map
    normal_map_url = db.Column(
        db.String(500),
        nullable=False
    )
...
def index():
    ...
    generated_maps = NormalMap.query.order_by(
        NormalMap.created_at.desc()
    ).all()
